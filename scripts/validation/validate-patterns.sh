...
if grep -q "uses: ./.github/shared/workflows/base-ci.yml" .github/workflows/ci.yml || grep -q "uses: ./.github/workflows/base-ci-shared.yml" .github/workflows/ci.yml; then
