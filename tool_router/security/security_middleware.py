...
class SecurityMiddleware:
    ...
    def check_request_security(
        ...
        blocked = (
            ...
            or risk_score >= 0.8
            or len(violations) > 5
            or (self.strict_mode and risk_score > 0.5)
        )
        ...
        metadata.update(
            {
                "validation_results": {
                    "prompt": {
                        ...
                        "risk": prompt_result.risk_score,
                    },
                    "preferences": {
                        "valid": prefs_result.is_valid,
                        "risk": prefs_result.risk_score,
                    },
                },
                "rate_limit": {
    ...
    def _get_rate_limit_config(self, context: SecurityContext) -> RateLimitConfig:
        ...
        if context.user_id:  # Authenticated user
