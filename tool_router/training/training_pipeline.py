...
from .data_extraction import PatternExtractor, ExtractedPattern, PatternCategory
from .knowledge_base import KnowledgeBase, KnowledgeItem, KnowledgeIndexer
...
class TrainingPipeline:
    ...
    def _validate_pattern_by_category(self, pattern: ExtractedPattern) -> bool:
        ...
        elif pattern.category == PatternCategory.ACCESSIBILITY:
        ...
        elif pattern.category == PatternCategory.PROMPT_ENGINEERING:
    ...
    def _generate_recommendations(self) -> List[str]:
        ...
        if not most_used:
            ...
            if low_usage_items:
                recommendations.append(f"Review and improve low-usage patterns: {', '.join(item['title'] for item in low_usage_items[:3])}")
