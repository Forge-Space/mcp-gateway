...
class CachePerformanceMetrics:
    ...
    last_invalidation_time: float | None = None
...
class CachePerformanceDashboard:
    ...
    def get_current_snapshot(self) -> CachePerformanceSnapshot | None:
...
_cache_performance_dashboard: CachePerformanceDashboard | None = None
...
def get_dashboard_data() -> CachePerformanceSnapshot | None:
